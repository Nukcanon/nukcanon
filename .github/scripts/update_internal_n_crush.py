...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == 'f14711dc213f42b03ec9fd1c85e886693ca73e45', 'New release descriptor is missing its source commit; build the game repository first'
