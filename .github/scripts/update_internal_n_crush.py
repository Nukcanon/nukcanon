...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == 'a04ef04b3b7136f44766f0525ef53e43baec2adb', 'New release descriptor is missing its source commit; build the game repository first'
