...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == '3e21b05e82a54787d77386b1260d4b4364e1bc29', 'New release descriptor is missing its source commit; build the game repository first'
