...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == '5c3b5026bfbb9417a46350ca27d592ffaed7c363', 'New release descriptor is missing its source commit; build the game repository first'
