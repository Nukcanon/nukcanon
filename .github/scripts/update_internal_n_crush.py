...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == 'fdf51c177e17cf2a1515952593b0292a0720c2e8', 'New release descriptor is missing its source commit; build the game repository first'
