...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == '9656451ce87b6a3726604810af30be9b6841a21d', 'New release descriptor is missing its source commit; build the game repository first'
