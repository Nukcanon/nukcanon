...
def main():
    ...
    if options.refresh_release:
        ...
        assert expected.get('source_commit') == '22e4a64839c5a7f80c926abb2f627c51fb911910', 'New release descriptor is missing its source commit; build the game repository first'
